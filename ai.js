...
async function* getAIResponse(db, userid, prompt) {
    ...
    const streamDelay = 30; // Delay in milliseconds between chunks
...
async function createSummary(summary, response) {

    const message = `create a new summary, orginal summary : ${summary}, new answer : ${response}`;
...
module.exports = { getAIResponse, createSummary };
